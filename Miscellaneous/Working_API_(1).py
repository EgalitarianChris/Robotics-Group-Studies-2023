...
def set_neutral_position():   #sets initial neutral position (returning error currently)
    ...
    nao.move_elbow_yaw(-0.9971)
    nao.move_head_yaw(0.0168)
    nao.move_head_pitch(0.5148)
    nao.move_hip_yaw_pitch(-0.0367)
    nao.move_ankle_roll(-0.0199)
    nao.move_hip_roll(-0.0014)